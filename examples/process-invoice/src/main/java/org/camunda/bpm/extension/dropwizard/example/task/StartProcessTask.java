...
import org.camunda.bpm.extension.dropwizard.example.DropwizardInvoiceExampleApplication;
...
public class StartProcessTask extends Task {
  ...
  public ProcessInstance startProcess() {
    return ProcessEngines.getDefaultProcessEngine().getRuntimeService().startProcessInstanceByKey(DropwizardInvoiceExampleApplication.PROCESS_DEFINITION_KEY);
  }
}
